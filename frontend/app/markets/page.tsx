...
//             lightColor: "from-indigo-600 to-blue-600",
...
//             change: "+0.003%",
//             trend: "up",
//             description: "Average perp funding"
//         },
//         {
//             label: "Open Interest",
//             value: "$34.2B",
...
//             change: "+5.2%",
//             trend: "up",
//             description: "24h unique"
//         }
//     ]

//     // ================ SECTORS ================
//     const sectors = [
//         { name: "DeFi", value: "$89.2B", change: "+3.8%", color: "bg-purple-500", dominance: "12.4%" },
//         { name: "Layer 1", value: "$1.2T", change: "+2.1%", color: "bg-blue-500", dominance: "49.8%" },
//         { name: "Layer 2", value: "$24.6B", change: "+6.2%", color: "bg-cyan-500", dominance: "10.2%" },
//         { name: "Gaming", value: "$28.6B", change: "+5.2%", color: "bg-green-500", dominance: "11.9%" },
//         { name: "Meme", value: "$12.4B", change: "-2.1%", color: "bg-yellow-500", dominance: "5.1%" },
//         { name: "RWA", value: "$8.2B", change: "+9.4%", color: "bg-orange-500", dominance: "3.4%" },
//         { name: "AI", value: "$15.8B", change: "+7.4%", color: "bg-pink-500", dominance: "6.6%" },
//         { name: "Infra", value: "$42.1B", change: "+1.2%", color: "bg-indigo-500", dominance: "17.5%" },
//     ]

//     // ================ TOP MOVERS ================
//     const topMovers = [
//         { name: "Bitcoin", symbol: "BTC", price: "$60,428", change: "+3.5%", volume: "$28.4B", trend: "up" },
//         { name: "Ethereum", symbol: "ETH", price: "$3,892", change: "+2.1%", volume: "$15.2B", trend: "up" },
//         { name: "Solana", symbol: "SOL", price: "$142.50", change: "+8.2%", volume: "$4.8B", trend: "up" },
//         { name: "Dogecoin", symbol: "DOGE", price: "$0.142", change: "-1.2%", volume: "$1.2B", trend: "down" },
//         { name: "Avalanche", symbol: "AVAX", price: "$42.18", change: "+5.7%", volume: "$892M", trend: "up" },
//         { name: "Polygon", symbol: "MATIC", price: "$0.89", change: "-0.8%", volume: "$456M", trend: "down" },
//     ]

//     // ================ NEWS ================
//     const marketNews = [
//         { time: "2m ago", title: "Bitcoin ETF inflows reach $500M", impact: "positive", sector: "BTC" },
//         { time: "15m ago", title: "Ethereum layer 2 TVL hits all-time high", impact: "positive", sector: "ETH" },
//         { time: "32m ago", title: "Solana network congestion update", impact: "neutral", sector: "SOL" },
//         { time: "1h ago", title: "DeFi protocol hacked for $12M", impact: "negative", sector: "DeFi" },
//         { time: "2h ago", title: "New regulatory framework proposed", impact: "neutral", sector: "Regulation" },
//     ]
...
//                             Comprehensive market analysis with sector performance, on-chain metrics, and real-time data.
//                         </p>
//                     </div>
...
//                                     </span>
//                                 </div>
//                                 <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">{index.name}</p>
//                                 <p className="text-lg font-bold text-gray-900 dark:text-white">{index.value}</p>
//                                 <p className="text-[11px] text-gray-400 dark:text-gray-500 mt-2">{index.components} assets</p>
//                             </div>
//                         </div>
//                     ))}
//                 </div>
...
//                         <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Total Exchanges</p>
...
//                         <p className="text-2xl font-bold text-gray-900 dark:text-white">47.3K</p>
//                     </div>
//                     <div className="metric-card p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
//                         <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Fear & Greed</p>
//                         <p className="text-2xl font-bold text-yellow-600 dark:text-yellow-400">72</p>
//                     </div>
//                     <div className="metric-card p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
//                         <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">BTC 52W High</p>
...
//                                 </div>
//                                 <p className="text-xs text-green-600 dark:text-green-400 mt-1">Bullish</p>
//                             </div>
//                             <div className="pt-3 border-t border-blue-200 dark:border-blue-800">
//                                 <div className="flex justify-between mb-2">
//                                     <span className="text-xs text-gray-600 dark:text-gray-400">BTC Dominance</span>
//                                     <span className="text-xs font-bold text-gray-900 dark:text-white">52.4%</span>
//                                 </div>
//                                 <div className="flex justify-between">
//                                     <span className="text-xs text-gray-600 dark:text-gray-400">ETH Dominance</span>
//                                     <span className="text-xs font-bold text-gray-900 dark:text-white">18.2%</span>
//                                 </div>
//                             </div>
//                         </div>
//                     </div>
...
//                             {["All", "Gainers", "Losers", "New", "DeFi", "NFT", "Gaming", "AI", "Layer 1", "Meme"].map((cat, i) => (
//                                 <button
//                                     key={i}
...
//                                     <span className="font-semibold text-gray-900 dark:text-white">12,450</span> assets
//                                 </span>
//                             </div>
//                             <div className="flex items-center gap-3">
//                                 <button 
...
//                                     disabled={page === 1}
//                                     className="px-4 py-2 text-xs font-medium bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 transition-colors">
//                                         Previous
//                                 </button>
//                                 <button 
//                                     onClick={() => setPage((prev) => prev + 1)}
//                                     disabled={endIndex >= coins.length}
//                                     className="px-4 py-2 text-xs font-medium bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-lg hover:shadow-lg hover:shadow-blue-500/25 transition-all">
//                                         Next
//                                 </button>
//                             </div>
//                         </div>
